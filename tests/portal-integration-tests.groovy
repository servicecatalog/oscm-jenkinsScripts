        ...
        stage('Tests - install ui tests') {
            catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                ...
                sh "docker run " +
                        ...
                        "-e HTTP_PROXY=\"${http_proxy}\" " +
                        "-e HTTPS_PROXY=\"${https_proxy}\" " +
                        "-e MAVEN_OPTS=\"-Duser.home=/build -Duser.home=/build -Dhttp.proxyHost=\"${HTTP_PROXY_PIPE}\" -Dhttp.proxyPort=\"${HTTP_PORT_PIPE}\"  -Dhttps.proxyHost=\"${HTTPs_PROXY_PIPE}\" -Dhttps.proxyPort=\"${HTTPs_PORT_PIPE}\" \" " +
